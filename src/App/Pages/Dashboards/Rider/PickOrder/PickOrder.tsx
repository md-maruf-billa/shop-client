      ...
      return (
            <div className="flex flex-col items-center py-10 ">
                  ...
                  <div className="flex items-center gap-5">
                        <Button onClick={() => handlePickOrder("Pending")} variant={"destructive"}>Cancel Pick</Button>
                        <Button
                              onClick={() => generatePDF(invoiceRef, { filename: "order Invoice.pdf" })}                        >
                              Download PDF
                        </Button>
                        <Button className="bg-green-600" disabled={state?.orderStatus == "Cancel" || state?.orderStatus == "On the way" || state?.orderStatus == "Shipped"} onClick={() => handlePickOrder("On the way")} >Pick This order</Button>
                  </div>
            </div>
      );
};
